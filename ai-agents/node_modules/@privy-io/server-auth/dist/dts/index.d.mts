import { CustomMetadataType, SmartWalletType, Prettify, PolicyActionType } from '@privy-io/public-api';
...
type EthereumRpcInputTypes = EthereumSignMessageInputType | EthereumSignTypedDataInputType | EthereumSignTransactionInputType | EthereumSendTransactionInputType | EthereumSecp256k1SignInputType;
...
type PolicyMethod = 'eth_signTransaction' | 'eth_sendTransaction' | 'eth_signTypedData_v4' | 'exportPrivateKey' | '*';
...
type WalletApiPolicyRuleConditionType = WalletApiPolicyEthereumTransactionCondition | WalletApiPolicyEthereumCalldataCondition | WalletApiPolicyEthereumTypedDataDomainCondition | WalletApiPolicyEthereumTypedDataMessageCondition;
...
type WalletApiPolicyEthereumTypedDataDomainCondition = {
    ...
    field: 'chain_id' | 'verifying_contract';
    operator: PolicyRuleConditionOperator;
    value: string | string[];
};
...
export { type AllowlistEntry, type AppSettings, type Apple, type AppleOAuthWithMetadata, type AuthTokenClaims, type ChainType, type CustomJwt, type CustomJwtWithMetadata, type Discord, type DiscordOAuthWithMetadata, type Email, type EmailWithMetadata, type EthereumPersonalSignRpcInputType, type EthereumRpcInputTypes, type EthereumSecp256k1SignInputType, type EthereumSendTransactionInputType, type EthereumSendTransactionResponseType, type EthereumSendTransactionRpcInputType, type EthereumSignMessageInputType, type EthereumSignMessageResponseType, type EthereumSignTransactionInputType, type EthereumSignTransactionResponseType, type EthereumSignTransactionRpcInputType, type EthereumSignTypedDataInputType, type EthereumSignTypedDataResponseType, type EthereumSignTypedDataRpcInputType, type EvmCaip2ChainId, type Farcaster, type FarcasterWithMetadata, type Github, type GithubOAuthWithMetadata, type Google, type GoogleOAuthWithMetadata, type Hex, type ImportUserInput, type Instagram, type InstagramOAuthWithMetadata, type LinkedAccountWithMetadata, type LinkedIn, type LinkedInOAuthWithMetadata, type Phone, type PhoneWithMetadata, type PolicyMethod, type PolicyRuleConditionOperator, PrivyClient, type Quantity, type SolanaCaip2ChainId, type SolanaRpcInputTypes, type SolanaSignAndSendTransactionInputType, type SolanaSignAndSendTransactionResponseType, type SolanaSignAndSendTransactionRpcInputType, type SolanaSignMessageInputType, type SolanaSignMessageResponseType, type SolanaSignMessageRpcInputType, type SolanaSignTransactionInputType, type SolanaSignTransactionResponseType, type SolanaSignTransactionRpcInputType, type Spotify, type SpotifyOAuthWithMetadata, type Telegram, type TelegramWithMetadata, type Tiktok, type TiktokOAuthWithMetadata, type Twitter, type TwitterOAuthWithMetadata, type User, type Wallet, type WalletApiCreateRequestType, type WalletApiEthereumPersonalSignRpcResponseType, type WalletApiEthereumSendTransactionRpcResponseType, type WalletApiEthereumSignTransactionRpcResponseType, type WalletApiEthereumSignTypedDataRpcResponseType, type WalletApiFindWalletsRequestType, type WalletApiFindWalletsResponseType, type WalletApiPolicyCreateRequestType, type WalletApiPolicyDeleteRequestType, type WalletApiPolicyEthereumCalldataCondition, type WalletApiPolicyEthereumTransactionCondition, type WalletApiPolicyEthereumTypedDataDomainCondition, type WalletApiPolicyEthereumTypedDataMessageCondition, type WalletApiPolicyResponseType, type WalletApiPolicyRuleConditionType, type WalletApiPolicyRuleType, type WalletApiPolicyUpdateRequestType, type WalletApiRpcInputType, type WalletApiRpcInputTypes, type WalletApiRpcResponseType, type WalletApiSolanaSignAndSendTransactionRpcResponseType, type WalletApiSolanaSignMessageRpcResponseType, type WalletApiSolanaSignTransactionRpcResponseType, type WalletApiTransactionResponseType, type WalletApiWalletResponseType, type WalletWithMetadata };
