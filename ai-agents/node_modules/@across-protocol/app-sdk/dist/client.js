...
import { getAvailableRoutes, getSuggestedFees, getLimits, getQuote, waitForDepositTx, getDeposit, getFillByDepositTx, simulateDepositTx, waitForFillTx, executeQuote, simulateUpdateDepositTx, signUpdateDepositTypedData, } from "./actions/index.js";
import { MAINNET_API_URL, MAINNET_INDEXER_API, TESTNET_API_URL, TESTNET_INDEXER_API, } from "./constants/index.js";
import { DefaultLogger, configurePublicClients, getSupportedChains, simulateTxOnTenderly, assertValidIntegratorId, } from "./utils/index.js";
import { AcrossApiSimulationError, ConfigError, SimulationError, } from "./errors/index.js";
...
export class AcrossClient {
    ...
    get isTenderlyEnabled() {
        return Boolean(this.tenderly?.accessKey &&
    ...
    async executeQuote(params) {
        ...
        const originClient = params?.originClient ??
            this.getPublicClient(params.deposit.originChainId);
        const destinationClient = params?.destinationClient ??
        ...
        try {
            const result = await simulateUpdateDepositTx({
                ...
                originChainClient: params.originChainClient ??
                    this.getPublicClient(params.deposit.originChainId),
                destinationChainClient: params.destinationChainClient ??
                    this.getPublicClient(params.deposit.destinationChainId),
            });
            return result;
        }
    ...
    async getDeposit(params) {
        const originSpokePoolAddress = params.findBy.originSpokePoolAddress ??
            (await this.getSpokePoolAddress(params.findBy.originChainId));
        const destinationSpokePoolAddress = params.findBy.destinationSpokePoolAddress ??
    ...
    async simulateTxOnTenderly(params) {
        ...
        if (!accessKey || !accountSlug || !projectSlug) {
            throw new ConfigError("Tenderly credentials not set. Client needs to be configured with " +
 ...
 * @public
 */
export function createAcrossClient(options) {
