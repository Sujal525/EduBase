 ...
 * @public
 */
export declare function getSuggestedFees({ apiUrl, logger, ...params }: GetSuggestedFeesParams): Promise<{
    outputAmount: bigint;
    fillDeadline: number;
    exclusivityDeadline: number;
    exclusiveRelayer: string;
...
export declare function parseSuggestedFees(raw: SuggestedFeesApiResponse): Omit<GetSuggestedFeesReturnType, "outputAmount">;
